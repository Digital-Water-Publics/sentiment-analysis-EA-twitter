...
sentiment_wrangle = function(sentiment) {
  ...
  lapply(cols_to_plot,function(i){
    ggplot(data = ooo, ,aes_string(y=cols_to_plot)) + geom_line()
  } )
  

  #Create plot with 1 month breaks

  p + scale_x_date(date_breaks = "1 month", date_labels = "%b")
  plots_folder = "plots/"
  ggsave(paste(plots_folder, sentiment, "_historical.png", sep = ""),width = 800,height = 600)
  
}
sentiment_wrangle(sentiment = "disgust")
