...
sample_flood = sample_n(flood_subset,1000) %>% select(word)
...
sample_pollution = sample_n(pollution_subset,1000) %>% select(word)
...
sample_water_indsustry = sample_n(water_indsustry_subset,1000) %>% select(word)
